...
export default function TaskCard({ task: t, li, ti, palette, onToggle, onContextMenu }: Props) {
  ...
  // Trigger border flash when task is checked — direct DOM for instant feedback
  const handleToggle = useCallback(() => {
    if (!t.done) {
      ...
      if (el) {
        ...
        el.style.border = `2px solid ${palette.c1}`;
        el.style.boxShadow = `0 0 0 3px ${palette.c1}66, 0 0 24px 6px ${palette.c1}44`;
