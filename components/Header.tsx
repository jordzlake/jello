        ...
        {!isMobile && (
          <span
            style={{
              ...
              background:
                "linear-gradient(135deg,#00d26a 0%,#ff81f5 55%,#ffd26b 100%)",
          ...
          {dashIds.map((id) => (
            <button
              ...
              style={{
                border: "1px solid",
                borderColor:
                  id === G.activeDash ? "var(--accent)" : "var(--border)",
                background:
                  id === G.activeDash ? "var(--accent)" : "var(--surface)",
                ...
                flexShrink: 0,
                boxShadow:
                  id === G.activeDash ? "0 0 14px rgba(111,95,255,.4)" : "none",
              }}
            >
...
function HamIcon({ open }: { open: boolean }) {
  ...
  return (
    <div style={{ width: 16, height: 12, position: "relative" }}>
      {open ? (
        <>
          <span style={{ ...s, transform: "rotate(45deg)", top: 5 }} />
          <span style={{ ...s, transform: "rotate(-45deg)", top: 5 }} />
        </>
      ) : (
        <>
          <span style={{ ...s, top: 0 }} />
          <span style={{ ...s, width: 12, top: 5 }} />
          <span style={{ ...s, top: 10 }} />
        </>
      )}
    </div>
